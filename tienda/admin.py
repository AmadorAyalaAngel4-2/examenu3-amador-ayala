...
class ProductoAdmin(admin.ModelAdmin):
    ...
    # --- CORREGIDO AQUÍ ---
    list_display = ('id', 'nombre', 'categoria', 'precio_venta', 'stock', 'activo', 'fecha_creacion')  # Columnas visibles
